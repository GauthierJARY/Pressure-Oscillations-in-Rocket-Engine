...
"""
Comment :
    not really interesting at the moment because not comparable with chiara results in example A2
    check for equations and boundary conditions => is it consistent ? 
"""
...
def a_sound(Pressure_current,Pressure_init,rho_init):
    ...
    if type_simulation == 0 :
        ...
        # return Pressure_current / rho_init
...
while t<20:
    ...
    P1n = P1 + dt * ( (m1_prev ) / (V_pipe_1) * a_sound(P1,P1i,rho1i) )
    ...
    aa = np.sqrt(a_sound(P2,P2i,rho2i))
