...
Comment : 
    ...
    xi and Re were adjusted to the new standard at 11/07
    we have too much dampling in the oscillations => maybe numerical accuracy is not good enough ? 
"""
...
def a_sound(Pressure_current,Pressure_init,rho_init):
    ...
    if type_simulation == 0 :
        ...
        return ( 2.2e9 / rho_init ) / (1+(d_pipe/0.02)*(2.2e9/50e9))
